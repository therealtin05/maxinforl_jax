...
class Transition(flax.struct.PyTreeNode):
    ...
    def flatten_dim(self) -> int:
        ...
        """
        flatten_dim = 2 * self.observation_dim + self.action_dim + 3 # +3 for reward, done, truncations
        return flatten_dim
...
class ReplayBuffer(flax.struct.PyTreeNode):
    ...
    def insert(self, transitions: Transition) -> ReplayBuffer:
        ...
        new_position = (new_position + num_transitions) % max_replay_size # khi full se ve 0
